...
namespace Tbot.Includes {
	public interface ICalculationService {
		...
		decimal CalcOptimalSpyProbeSpeed(Coordinate origin, Coordinate destination, Ships ships, long availableFuel, Researches researches, ServerData serverData, LFBonuses lfBonuses = null, CharacterClass playerClass = CharacterClass.NoClass, AllianceClass allyClass = AllianceClass.NoClass);
